...
function generateData() {
	var data = [];
	/*var date = new Date();
	data.push({'value' : 0, 'date' : '10/16'});
	data.push({'value' : 0, 'date' : '10/17'});
	data.push({'value' : 2, 'date' : '10/18'});
	data.push({'value' : 2, 'date' : '10/19'});
	data.push({'value' : 4, 'date' : '10/20'});
	data.push({'value' : 4, 'date' : '10/21'});*/
	...
	while (i <= 19) {
		...
		if(i==8)
			data.push({'value' : 500, 'date' : date});
		if(i==9)
			data.push({'value' : 1000, 'date' : date});
		if(i==10)
			data.push({'value' : 2000, 'date' : date});
		if(i==11)
			data.push({'value' : 2300, 'date' : date});
		if(i==12)
			data.push({'value' : 1500, 'date' : date});
		if(i==13)
			data.push({'value' : 1900, 'date' : date});
		if(i==14)
			data.push({'value' : 3000, 'date' : date});
		if(i==15)
			data.push({'value' : 3900, 'date' : date});
		if(i==16)
			data.push({'value' : 2200, 'date' : date});
		if(i==17)
			data.push({'value' : 1800, 'date' : date});
		if(i==18)
			data.push({'value' : 2000, 'date' : date});
		if(i==19)
			data.push({'value' : 2100, 'date' : date});
		i++;
	}
	return data;
}
